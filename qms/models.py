...
class QmsTrainingSchedule(models.Model):
    ...
    reschedule_training_date = models.DateTimeField(auto_now_add=False, db_index=True, null=True)
...
class CespTrainingScheduleModel(models.Model):
    id = models.AutoField(primary_key=True)
    sr_no = models.CharField(max_length=300)
    training_type = models.TextField()
    training_start_date = models.DateTimeField(auto_now_add=False, db_index=True, null=True)
    ...
    no_of_participants = models.CharField(max_length=300,null=True)
    Created_at = models.DateTimeField(auto_now_add=True)
class CeSPAuditScheduleModel(models.Model):
    id = models.AutoField(primary_key=True)
    sr_no = models.CharField(max_length=300)
    commission = models.CharField(max_length=300)
    organization = models.CharField(max_length=300)
